  ...
  return (
    <div className="space-y-4">
                ...
                <TableRow>
                  {[
                    ...
                    <TableCell
                      ...
                      onClick={() => key !== "wallet" ? handleSort(key as keyof Student) : undefined}
                    >
                ...
                {filteredAndSortedData.length > 0 ? (
                  filteredAndSortedData.map((student) => (
                    <TableRow key={student.id} className="hover:bg-gray-50 dark:hover:bg-gray-800/50">
                      ...
                      <TableCell className="px-5 py-4 text-start">
                        <Link
                          href={`/admin/students/wallet-history/${student.id}`}
                  ...
                  <TableRow>
                    ...
                    >
                      No Students wallet found matching your criteria.
                    </TableCell>
                  </TableRow>
                )}
              </TableBody>
      ...
      <div className="text-sm text-gray-500 dark:text-gray-400">
        Showing {filteredAndSortedData.length} of {tableData.length} students wallets
      </div>
