  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-4">
        <div>
          <h1 className="text-2xl font-bold text-gray-900 dark:text-white">Student Resources</h1>
          <p className="text-gray-600 dark:text-gray-400">Manage educational resources for students</p>
        </div>
        <button
        ...
        {loading ? (
          ...
          <div className="p-12 text-center">
            ...
            <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
              Get started by creating a new resource for students.
            </p>
            <button
              onClick={openAddModal}
