...
import { Edit, Trash, Book, Building2, GraduationCap, Calendar, Star, DollarSign } from "lucide-react";
      ...
      <div className="flex flex-col sm:flex-row">
        ...
        <div className="flex-1 max-w-md">
          <div className="relative">
            <input
              type="text"
              placeholder="Search by course name, university, discipline, study level, intake, or fee..."
              value={searchTerm}
