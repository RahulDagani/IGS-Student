...
const fetchExperiences = async () => {
  try {
    setLoading(true);
    const response = await fetch(`${BASE_URL}/tenant/student/work/experience/${studentId}`, {
      headers: {
...
const handleEdit = (experience: WorkExperience) => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      const url = editingId 
        ? `${BASE_URL}/tenant/student/work/experience/${studentId}/${editingId}`
        : `${BASE_URL}/tenant/student/work/experience/${studentId}`;
