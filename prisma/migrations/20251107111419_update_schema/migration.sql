/*
  ...
  - You are about to drop the column `avatar` on the `apply_tenant_users` table. All the data in the column will be lost.
  - You are about to drop the column `is_active` on the `apply_tenant_users` table. All the data in the column will be lost.
  - You are about to drop the column `is_email_verified` on the `apply_tenant_users` table. All the data in the column will be lost.
  - You are about to drop the column `last_login_at` on the `apply_tenant_users` table. All the data in the column will be lost.
  - You are about to drop the column `password_hash` on the `apply_tenant_users` table. All the data in the column will be lost.
  - You are about to drop the column `phone` on the `apply_tenant_users` table. All the data in the column will be lost.
  - You are about to drop the column `is_active` on the `apply_tenants` table. All the data in the column will be lost.
  - You are about to drop the column `settings` on the `apply_tenants` table. All the data in the column will be lost.
  - You are about to drop the column `subscription_ends_at` on the `apply_tenants` table. All the data in the column will be lost.
  - You are about to drop the column `trial_ends_at` on the `apply_tenants` table. All the data in the column will be lost.
  - You are about to drop the `_apply_tenant_applicationsToapply_tenant_universities` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `apply_domains` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `apply_payments` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `apply_plans` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `apply_subscription_requests` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `apply_subscriptions` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `apply_tenant_admin_profiles` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `apply_tenant_agent_profiles` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `apply_tenant_agent_students` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `apply_tenant_applications` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `apply_tenant_courses` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `apply_tenant_staff_profiles` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `apply_tenant_student_profiles` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `apply_tenant_support_replies` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `apply_tenant_support_tickets` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `apply_tenant_universities` table. If the table is not empty, all the data it contains will be lost.
  - You are about to drop the `apply_tenant_user_permissions` table. If the table is not empty, all the data it contains will be lost.
  - A unique constraint covering the columns `[email]` on the table `apply_tenant_users` will be added. If there are existing duplicate values, this will fail.
...
-- DropForeignKey
ALTER TABLE "public"."_apply_tenant_applicationsToapply_tenant_universities" DROP CONSTRAINT "_apply_tenant_applicationsToapply_tenant_universities_A_fkey";

-- DropForeignKey
ALTER TABLE "public"."_apply_tenant_applicationsToapply_tenant_universities" DROP CONSTRAINT "_apply_tenant_applicationsToapply_tenant_universities_B_fkey";

-- DropForeignKey
ALTER TABLE "public"."apply_domains" DROP CONSTRAINT "apply_domains_tenant_id_fkey";

-- DropForeignKey
ALTER TABLE "public"."apply_payments" DROP CONSTRAINT "apply_payments_plan_id_fkey";

-- DropForeignKey
ALTER TABLE "public"."apply_payments" DROP CONSTRAINT "apply_payments_tenant_id_fkey";

-- DropForeignKey
ALTER TABLE "public"."apply_subscription_requests" DROP CONSTRAINT "apply_subscription_requests_plan_id_fkey";

-- DropForeignKey
ALTER TABLE "public"."apply_subscription_requests" DROP CONSTRAINT "apply_subscription_requests_tenant_id_fkey";

-- DropForeignKey
ALTER TABLE "public"."apply_subscriptions" DROP CONSTRAINT "apply_subscriptions_plan_id_fkey";

-- DropForeignKey
ALTER TABLE "public"."apply_subscriptions" DROP CONSTRAINT "apply_subscriptions_tenant_id_fkey";

-- DropForeignKey
ALTER TABLE "public"."apply_tenant_admin_profiles" DROP CONSTRAINT "apply_tenant_admin_profiles_tenant_id_fkey";

-- DropForeignKey
ALTER TABLE "public"."apply_tenant_admin_profiles" DROP CONSTRAINT "apply_tenant_admin_profiles_user_id_fkey";

-- DropForeignKey
ALTER TABLE "public"."apply_tenant_agent_profiles" DROP CONSTRAINT "apply_tenant_agent_profiles_tenant_id_fkey";

-- DropForeignKey
ALTER TABLE "public"."apply_tenant_agent_profiles" DROP CONSTRAINT "apply_tenant_agent_profiles_user_id_fkey";

-- DropForeignKey
ALTER TABLE "public"."apply_tenant_agent_students" DROP CONSTRAINT "apply_tenant_agent_students_agent_id_fkey";

-- DropForeignKey
ALTER TABLE "public"."apply_tenant_agent_students" DROP CONSTRAINT "apply_tenant_agent_students_student_id_fkey";

-- DropForeignKey
ALTER TABLE "public"."apply_tenant_agent_students" DROP CONSTRAINT "apply_tenant_agent_students_tenant_id_fkey";

-- DropForeignKey
ALTER TABLE "public"."apply_tenant_applications" DROP CONSTRAINT "apply_tenant_applications_assigned_staff_id_fkey";

-- DropForeignKey
ALTER TABLE "public"."apply_tenant_applications" DROP CONSTRAINT "apply_tenant_applications_course_id_fkey";

-- DropForeignKey
ALTER TABLE "public"."apply_tenant_applications" DROP CONSTRAINT "apply_tenant_applications_student_id_fkey";

-- DropForeignKey
ALTER TABLE "public"."apply_tenant_applications" DROP CONSTRAINT "apply_tenant_applications_tenant_id_fkey";

-- DropForeignKey
ALTER TABLE "public"."apply_tenant_courses" DROP CONSTRAINT "apply_tenant_courses_tenant_id_fkey";

-- DropForeignKey
ALTER TABLE "public"."apply_tenant_courses" DROP CONSTRAINT "apply_tenant_courses_university_id_fkey";

-- DropForeignKey
ALTER TABLE "public"."apply_tenant_staff_profiles" DROP CONSTRAINT "apply_tenant_staff_profiles_tenant_id_fkey";

-- DropForeignKey
ALTER TABLE "public"."apply_tenant_staff_profiles" DROP CONSTRAINT "apply_tenant_staff_profiles_user_id_fkey";

-- DropForeignKey
ALTER TABLE "public"."apply_tenant_student_profiles" DROP CONSTRAINT "apply_tenant_student_profiles_tenant_id_fkey";

-- DropForeignKey
ALTER TABLE "public"."apply_tenant_student_profiles" DROP CONSTRAINT "apply_tenant_student_profiles_user_id_fkey";

-- DropForeignKey
ALTER TABLE "public"."apply_tenant_support_replies" DROP CONSTRAINT "apply_tenant_support_replies_tenant_id_fkey";

-- DropForeignKey
ALTER TABLE "public"."apply_tenant_support_replies" DROP CONSTRAINT "apply_tenant_support_replies_ticket_id_fkey";

-- DropForeignKey
ALTER TABLE "public"."apply_tenant_support_replies" DROP CONSTRAINT "apply_tenant_support_replies_user_id_fkey";

-- DropForeignKey
ALTER TABLE "public"."apply_tenant_support_tickets" DROP CONSTRAINT "apply_tenant_support_tickets_agent_id_fkey";

-- DropForeignKey
ALTER TABLE "public"."apply_tenant_support_tickets" DROP CONSTRAINT "apply_tenant_support_tickets_assigned_staff_id_fkey";

-- DropForeignKey
ALTER TABLE "public"."apply_tenant_support_tickets" DROP CONSTRAINT "apply_tenant_support_tickets_student_id_fkey";

-- DropForeignKey
ALTER TABLE "public"."apply_tenant_support_tickets" DROP CONSTRAINT "apply_tenant_support_tickets_tenant_id_fkey";

-- DropForeignKey
ALTER TABLE "public"."apply_tenant_universities" DROP CONSTRAINT "apply_tenant_universities_tenant_id_fkey";

-- DropForeignKey
ALTER TABLE "public"."apply_tenant_user_permissions" DROP CONSTRAINT "apply_tenant_user_permissions_tenant_id_fkey";

-- DropForeignKey
ALTER TABLE "public"."apply_tenant_user_permissions" DROP CONSTRAINT "apply_tenant_user_permissions_user_id_fkey";

-- DropForeignKey
ALTER TABLE "public"."apply_tenant_users" DROP CONSTRAINT "apply_tenant_users_tenant_id_fkey";

-- DropForeignKey
ALTER TABLE "public"."apply_tenants" DROP CONSTRAINT "apply_tenants_plan_id_fkey";

-- DropIndex
DROP INDEX "public"."apply_tenant_users_tenant_id_email_key";

-- DropIndex
DROP INDEX "public"."apply_tenant_users_uuid_key";

-- DropIndex
DROP INDEX "public"."apply_tenants_status_idx";

-- AlterTable
ALTER TABLE "apply_tenant_users" DROP COLUMN "avatar",
...
-- AlterTable
ALTER TABLE "apply_tenants" DROP COLUMN "is_active",
...
-- DropTable
DROP TABLE "public"."_apply_tenant_applicationsToapply_tenant_universities";

-- DropTable
DROP TABLE "public"."apply_domains";

-- DropTable
DROP TABLE "public"."apply_payments";

-- DropTable
DROP TABLE "public"."apply_plans";

-- DropTable
DROP TABLE "public"."apply_subscription_requests";

-- DropTable
DROP TABLE "public"."apply_subscriptions";

-- DropTable
DROP TABLE "public"."apply_tenant_admin_profiles";

-- DropTable
DROP TABLE "public"."apply_tenant_agent_profiles";

-- DropTable
DROP TABLE "public"."apply_tenant_agent_students";

-- DropTable
DROP TABLE "public"."apply_tenant_applications";

-- DropTable
DROP TABLE "public"."apply_tenant_courses";

-- DropTable
DROP TABLE "public"."apply_tenant_staff_profiles";

-- DropTable
DROP TABLE "public"."apply_tenant_student_profiles";

-- DropTable
DROP TABLE "public"."apply_tenant_support_replies";

-- DropTable
DROP TABLE "public"."apply_tenant_support_tickets";

-- DropTable
DROP TABLE "public"."apply_tenant_universities";

-- DropTable
DROP TABLE "public"."apply_tenant_user_permissions";
...
-- DropEnum
DROP TYPE "public"."DomainType";

-- DropEnum
DROP TYPE "public"."PermissionModule";

-- DropEnum
DROP TYPE "public"."StudentType";
...
-- CreateTable
CREATE TABLE "apply_student_meta" (
    "id" SERIAL NOT NULL,
    "uuid" TEXT NOT NULL,
    "tenant_id" INTEGER NOT NULL,
    "user_id" INTEGER NOT NULL,
    ...
    CONSTRAINT "apply_student_meta_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "apply_student_interests" (
    "id" SERIAL NOT NULL,
    "uuid" TEXT NOT NULL,
    "tenant_id" INTEGER NOT NULL,
    "student_id" INTEGER NOT NULL,
    ...
    CONSTRAINT "apply_student_interests_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "apply_applications_status" (
    "id" SERIAL NOT NULL,
    "uuid" TEXT NOT NULL,
    "status" VARCHAR(100) NOT NULL,
    "created_at" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    ...
    CONSTRAINT "apply_applications_status_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "apply_student_applications" (
    "id" SERIAL NOT NULL,
    "uuid" TEXT NOT NULL,
    "tenant_id" INTEGER NOT NULL,
    "student_id" INTEGER NOT NULL,
    ...
    CONSTRAINT "apply_student_applications_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "apply_track_app_status" (
    "id" SERIAL NOT NULL,
    "uuid" TEXT NOT NULL,
    "tenant_id" INTEGER NOT NULL,
    "user_id" INTEGER NOT NULL,
    ...
    CONSTRAINT "apply_track_app_status_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "apply_student_required_docs" (
    "id" SERIAL NOT NULL,
    "uuid" TEXT NOT NULL,
    "tenant_id" INTEGER NOT NULL,
    "study_level" VARCHAR(255) NOT NULL,
    ...
    CONSTRAINT "apply_student_required_docs_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "apply_student_app_required_docs" (
    "id" SERIAL NOT NULL,
    "uuid" TEXT NOT NULL,
    "tenant_id" INTEGER NOT NULL,
    "application_id" INTEGER NOT NULL,
    ...
    CONSTRAINT "apply_student_app_required_docs_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "apply_student_application_docs" (
    "id" SERIAL NOT NULL,
    "uuid" TEXT NOT NULL,
    "tenant_id" INTEGER NOT NULL,
    "application_id" INTEGER NOT NULL,
    ...
    CONSTRAINT "apply_student_application_docs_pkey" PRIMARY KEY ("id")
);

-- CreateTable
CREATE TABLE "apply_student_docs" (
    "id" SERIAL NOT NULL,
    "uuid" TEXT NOT NULL,
    "tenant_id" INTEGER NOT NULL,
    "student_id" INTEGER NOT NULL,
    ...
    CONSTRAINT "apply_student_docs_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "apply_student_meta_uuid_key" ON "apply_student_meta"("uuid");

-- CreateIndex
CREATE UNIQUE INDEX "apply_student_meta_user_id_key" ON "apply_student_meta"("user_id");

-- CreateIndex
CREATE UNIQUE INDEX "apply_student_meta_alternate_email_key" ON "apply_student_meta"("alternate_email");

-- CreateIndex
CREATE INDEX "apply_student_meta_tenant_id_idx" ON "apply_student_meta"("tenant_id");

-- CreateIndex
CREATE INDEX "apply_student_meta_user_id_idx" ON "apply_student_meta"("user_id");

-- CreateIndex
CREATE INDEX "apply_student_meta_alternate_email_idx" ON "apply_student_meta"("alternate_email");

-- CreateIndex
CREATE INDEX "apply_student_meta_alternate_phone_number_idx" ON "apply_student_meta"("alternate_phone_number");

-- CreateIndex
CREATE INDEX "apply_student_meta_citizenship_idx" ON "apply_student_meta"("citizenship");

-- CreateIndex
CREATE INDEX "apply_student_meta_country_idx" ON "apply_student_meta"("country");

-- CreateIndex
CREATE INDEX "apply_student_meta_created_at_idx" ON "apply_student_meta"("created_at");

-- CreateIndex
CREATE UNIQUE INDEX "apply_student_meta_tenant_id_user_id_key" ON "apply_student_meta"("tenant_id", "user_id");

-- CreateIndex
CREATE UNIQUE INDEX "apply_student_interests_uuid_key" ON "apply_student_interests"("uuid");

-- CreateIndex
CREATE INDEX "apply_student_interests_tenant_id_idx" ON "apply_student_interests"("tenant_id");

-- CreateIndex
CREATE INDEX "apply_student_interests_student_id_idx" ON "apply_student_interests"("student_id");

-- CreateIndex
CREATE INDEX "apply_student_interests_preferred_country_idx" ON "apply_student_interests"("preferred_country");

-- CreateIndex
CREATE INDEX "apply_student_interests_level_of_study_idx" ON "apply_student_interests"("level_of_study");

-- CreateIndex
CREATE INDEX "apply_student_interests_discipline_idx" ON "apply_student_interests"("discipline");

-- CreateIndex
CREATE INDEX "apply_student_interests_created_at_idx" ON "apply_student_interests"("created_at");

-- CreateIndex
CREATE UNIQUE INDEX "apply_student_interests_tenant_id_student_id_key" ON "apply_student_interests"("tenant_id", "student_id");

-- CreateIndex
CREATE UNIQUE INDEX "apply_applications_status_uuid_key" ON "apply_applications_status"("uuid");

-- CreateIndex
CREATE UNIQUE INDEX "apply_applications_status_status_key" ON "apply_applications_status"("status");

-- CreateIndex
CREATE INDEX "apply_applications_status_status_idx" ON "apply_applications_status"("status");

-- CreateIndex
CREATE INDEX "apply_applications_status_created_at_idx" ON "apply_applications_status"("created_at");

-- CreateIndex
CREATE UNIQUE INDEX "apply_student_applications_uuid_key" ON "apply_student_applications"("uuid");

-- CreateIndex
CREATE INDEX "apply_student_applications_tenant_id_idx" ON "apply_student_applications"("tenant_id");

-- CreateIndex
CREATE INDEX "apply_student_applications_student_id_idx" ON "apply_student_applications"("student_id");

-- CreateIndex
CREATE INDEX "apply_student_applications_course_id_idx" ON "apply_student_applications"("course_id");

-- CreateIndex
CREATE INDEX "apply_student_applications_status_id_idx" ON "apply_student_applications"("status_id");

-- CreateIndex
CREATE INDEX "apply_student_applications_university_slug_idx" ON "apply_student_applications"("university_slug");

-- CreateIndex
CREATE INDEX "apply_student_applications_course_slug_idx" ON "apply_student_applications"("course_slug");

-- CreateIndex
CREATE INDEX "apply_student_applications_application_status_id_idx" ON "apply_student_applications"("application_status_id");

-- CreateIndex
CREATE INDEX "apply_student_applications_fee_status_idx" ON "apply_student_applications"("fee_status");

-- CreateIndex
CREATE INDEX "apply_student_applications_assigned_to_idx" ON "apply_student_applications"("assigned_to");

-- CreateIndex
CREATE INDEX "apply_student_applications_created_at_idx" ON "apply_student_applications"("created_at");

-- CreateIndex
CREATE UNIQUE INDEX "apply_track_app_status_uuid_key" ON "apply_track_app_status"("uuid");

-- CreateIndex
CREATE UNIQUE INDEX "apply_track_app_status_application_id_key" ON "apply_track_app_status"("application_id");

-- CreateIndex
CREATE INDEX "apply_track_app_status_tenant_id_idx" ON "apply_track_app_status"("tenant_id");

-- CreateIndex
CREATE INDEX "apply_track_app_status_user_id_idx" ON "apply_track_app_status"("user_id");

-- CreateIndex
CREATE INDEX "apply_track_app_status_student_id_idx" ON "apply_track_app_status"("student_id");

-- CreateIndex
CREATE INDEX "apply_track_app_status_application_id_idx" ON "apply_track_app_status"("application_id");

-- CreateIndex
CREATE INDEX "apply_track_app_status_created_at_idx" ON "apply_track_app_status"("created_at");

-- CreateIndex
CREATE UNIQUE INDEX "apply_track_app_status_tenant_id_application_id_key" ON "apply_track_app_status"("tenant_id", "application_id");

-- CreateIndex
CREATE UNIQUE INDEX "apply_student_required_docs_uuid_key" ON "apply_student_required_docs"("uuid");

-- CreateIndex
CREATE INDEX "apply_student_required_docs_tenant_id_idx" ON "apply_student_required_docs"("tenant_id");

-- CreateIndex
CREATE INDEX "apply_student_required_docs_study_level_idx" ON "apply_student_required_docs"("study_level");

-- CreateIndex
CREATE INDEX "apply_student_required_docs_document_key_idx" ON "apply_student_required_docs"("document_key");

-- CreateIndex
CREATE INDEX "apply_student_required_docs_required_idx" ON "apply_student_required_docs"("required");

-- CreateIndex
CREATE INDEX "apply_student_required_docs_created_at_idx" ON "apply_student_required_docs"("created_at");

-- CreateIndex
CREATE UNIQUE INDEX "apply_student_required_docs_tenant_id_study_level_document__key" ON "apply_student_required_docs"("tenant_id", "study_level", "document_key");

-- CreateIndex
CREATE UNIQUE INDEX "apply_student_app_required_docs_uuid_key" ON "apply_student_app_required_docs"("uuid");

-- CreateIndex
CREATE INDEX "apply_student_app_required_docs_tenant_id_idx" ON "apply_student_app_required_docs"("tenant_id");

-- CreateIndex
CREATE INDEX "apply_student_app_required_docs_application_id_idx" ON "apply_student_app_required_docs"("application_id");

-- CreateIndex
CREATE INDEX "apply_student_app_required_docs_document_key_idx" ON "apply_student_app_required_docs"("document_key");

-- CreateIndex
CREATE INDEX "apply_student_app_required_docs_required_idx" ON "apply_student_app_required_docs"("required");

-- CreateIndex
CREATE INDEX "apply_student_app_required_docs_created_at_idx" ON "apply_student_app_required_docs"("created_at");

-- CreateIndex
CREATE UNIQUE INDEX "apply_student_app_required_docs_tenant_id_application_id_do_key" ON "apply_student_app_required_docs"("tenant_id", "application_id", "document_key");

-- CreateIndex
CREATE UNIQUE INDEX "apply_student_application_docs_uuid_key" ON "apply_student_application_docs"("uuid");

-- CreateIndex
CREATE INDEX "apply_student_application_docs_tenant_id_idx" ON "apply_student_application_docs"("tenant_id");

-- CreateIndex
CREATE INDEX "apply_student_application_docs_application_id_idx" ON "apply_student_application_docs"("application_id");

-- CreateIndex
CREATE INDEX "apply_student_application_docs_student_id_idx" ON "apply_student_application_docs"("student_id");

-- CreateIndex
CREATE INDEX "apply_student_application_docs_document_type_id_idx" ON "apply_student_application_docs"("document_type_id");

-- CreateIndex
CREATE INDEX "apply_student_application_docs_status_idx" ON "apply_student_application_docs"("status");

-- CreateIndex
CREATE INDEX "apply_student_application_docs_verified_by_idx" ON "apply_student_application_docs"("verified_by");

-- CreateIndex
CREATE INDEX "apply_student_application_docs_uploaded_at_idx" ON "apply_student_application_docs"("uploaded_at");

-- CreateIndex
CREATE INDEX "apply_student_application_docs_created_at_idx" ON "apply_student_application_docs"("created_at");

-- CreateIndex
CREATE UNIQUE INDEX "apply_student_application_docs_tenant_id_application_id_doc_key" ON "apply_student_application_docs"("tenant_id", "application_id", "document_type_id");

-- CreateIndex
CREATE UNIQUE INDEX "apply_student_docs_uuid_key" ON "apply_student_docs"("uuid");

-- CreateIndex
CREATE INDEX "apply_student_docs_tenant_id_idx" ON "apply_student_docs"("tenant_id");

-- CreateIndex
CREATE INDEX "apply_student_docs_student_id_idx" ON "apply_student_docs"("student_id");

-- CreateIndex
CREATE INDEX "apply_student_docs_document_type_id_idx" ON "apply_student_docs"("document_type_id");

-- CreateIndex
CREATE INDEX "apply_student_docs_status_idx" ON "apply_student_docs"("status");

-- CreateIndex
CREATE INDEX "apply_student_docs_verified_by_idx" ON "apply_student_docs"("verified_by");

-- CreateIndex
CREATE INDEX "apply_student_docs_uploaded_at_idx" ON "apply_student_docs"("uploaded_at");

-- CreateIndex
CREATE INDEX "apply_student_docs_created_at_idx" ON "apply_student_docs"("created_at");

-- CreateIndex
CREATE UNIQUE INDEX "apply_student_docs_tenant_id_student_id_document_type_id_key" ON "apply_student_docs"("tenant_id", "student_id", "document_type_id");
...
-- CreateIndex
CREATE INDEX "apply_tenant_users_created_at_idx" ON "apply_tenant_users"("created_at");
...
-- AddForeignKey
ALTER TABLE "apply_student_meta" ADD CONSTRAINT "apply_student_meta_user_id_fkey" FOREIGN KEY ("user_id") REFERENCES "apply_tenant_users"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "apply_student_interests" ADD CONSTRAINT "apply_student_interests_student_id_fkey" FOREIGN KEY ("student_id") REFERENCES "apply_student_meta"("user_id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "apply_student_applications" ADD CONSTRAINT "apply_student_applications_application_status_id_fkey" FOREIGN KEY ("application_status_id") REFERENCES "apply_applications_status"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "apply_student_applications" ADD CONSTRAINT "apply_student_applications_assigned_to_fkey" FOREIGN KEY ("assigned_to") REFERENCES "apply_tenant_users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "apply_student_applications" ADD CONSTRAINT "apply_student_applications_student_id_fkey" FOREIGN KEY ("student_id") REFERENCES "apply_student_meta"("user_id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "apply_track_app_status" ADD CONSTRAINT "apply_track_app_status_application_id_fkey" FOREIGN KEY ("application_id") REFERENCES "apply_student_applications"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "apply_student_app_required_docs" ADD CONSTRAINT "apply_student_app_required_docs_application_id_fkey" FOREIGN KEY ("application_id") REFERENCES "apply_student_applications"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "apply_student_application_docs" ADD CONSTRAINT "apply_student_application_docs_application_id_fkey" FOREIGN KEY ("application_id") REFERENCES "apply_student_applications"("id") ON DELETE CASCADE ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "apply_student_application_docs" ADD CONSTRAINT "apply_student_application_docs_document_type_id_fkey" FOREIGN KEY ("document_type_id") REFERENCES "apply_student_app_required_docs"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "apply_student_application_docs" ADD CONSTRAINT "apply_student_application_docs_verified_by_fkey" FOREIGN KEY ("verified_by") REFERENCES "apply_tenant_users"("id") ON DELETE SET NULL ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "apply_student_docs" ADD CONSTRAINT "apply_student_docs_document_type_id_fkey" FOREIGN KEY ("document_type_id") REFERENCES "apply_student_required_docs"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "apply_student_docs" ADD CONSTRAINT "apply_student_docs_student_id_fkey" FOREIGN KEY ("student_id") REFERENCES "apply_tenant_users"("id") ON DELETE RESTRICT ON UPDATE CASCADE;

-- AddForeignKey
ALTER TABLE "apply_student_docs" ADD CONSTRAINT "apply_student_docs_verified_by_fkey" FOREIGN KEY ("verified_by") REFERENCES "apply_tenant_users"("id") ON DELETE SET NULL ON UPDATE CASCADE;
