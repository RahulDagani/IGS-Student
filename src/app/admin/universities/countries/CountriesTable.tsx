...
interface AddEditCountryModalProps {
  isOpen: boolean;
  onClose: () => void;
  onSave: (countryData: { country: string }) => void;
  mode: "add" | "edit";
  initialData?: Country;
}
...
export default function CountriesTable() {
  ...
  const [countries, setCountries] = useState<Country[]>(tableData);
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
        ...
        <div className="bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-800 p-4">
          ...
          <div className="text-2xl font-bold text-blue-600 dark:text-blue-400">
            {filteredAndSortedData.filter(c => 
              ["United States", "Canada"].includes(c.country)
            ).length}
          </div>
        </div>
        <div className="bg-white dark:bg-gray-900 rounded-lg border border-gray-200 dark:border-gray-800 p-4">
          ...
          <div className="text-2xl font-bold text-green-600 dark:text-green-400">
            {filteredAndSortedData.filter(c => 
              ["United Kingdom", "Germany", "France"].includes(c.country)
            ).length}
          </div>
        </div>
      </div>
