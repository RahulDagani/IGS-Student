        ...
        <div className="p-6 grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div>
            ...
            <select
              ...
              onChange={(e) => handleSelectChange('student_id', e.target.value === "all" ? "all" : Number(e.target.value))}
...
// Document Upload Modal Component (same as before)
...
export default function ApplicationsTable() {
  ...
  const fetchApplications = useCallback(async () => {
    try {
      ...
      const url = `${BASE_URL}/agent/student/application/filters/dynamic${queryString ? `?${queryString}` : ''}`;
