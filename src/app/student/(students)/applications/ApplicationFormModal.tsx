...
import { User, Calendar, Phone, Mail, MapPin, Globe, Users, Plus, AlertTriangle, X } from "lucide-react";
...
export default function StudentApplicationModal({ 
  ...
  if (isLoading) {
    return (
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/50 backdrop-blur-sm">
        <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-xl w-full max-w-4xl mx-4 max-h-[90vh] overflow-hidden">
  ...
  return (
    <div className="fixed inset-0 z-99999 flex items-center justify-center bg-black/50 backdrop-blur-sm">
      <div className="bg-white dark:bg-gray-900 rounded-2xl shadow-xl w-full max-w-5xl mx-4 max-h-[90vh] overflow-hidden">
        {/* Modal Header */}
