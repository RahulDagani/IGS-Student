...
import { DockIcon, DollarSign, GraduationCap } from "lucide-react";
...
const FilterModal: React.FC<FilterModalProps> = ({
  ...
  const [selectedStates] = useState<string[]>([]);
    ...
    <div className="w-full bg-white dark:bg-gray-800 rounded-2xl shadow-md p-5 border border-gray-100 dark:border-gray-700">
      ...
      <div className="flex items-start justify-between">
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            <h2 className="text-2xl font-semibold text-gray-800 dark:text-white leading-snug">
              {program.course}
            </h2>
      ...
      <div className="mt-6 flex gap-3">
         <Link href={`/univeristy/programs/edit/${program.id}`}
        ...
        <Link href={`/univeristy/programs/${program.id}`}
        className="flex-1 bg-indigo-600 hover:bg-indigo-700 text-center dark:bg-indigo-700 dark:hover:bg-indigo-600 text-white font-semibold py-2 rounded-lg text-sm transition-all"
        >
...
export default function ProgramCards() {
  ...
  const filteredAndSortedData = useMemo(() => {
    const filtered = tableData.filter((program) => {
      ...
      return matchesStudyLevel && matchesDiscipline && matchesCountry && matchesState;
    });
      ...
      <div className="flex flex-col sm:flex-row gap-4 justify-between">
        ...
        <div className="flex items-center gap-3">
          ...
          >
            ...
            <Link href="/university/programs/add" className="shrink-0">
